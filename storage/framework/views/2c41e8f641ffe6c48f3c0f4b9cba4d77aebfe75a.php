...
<html class="loading" lang="<?php if(session()->has('locale')): ?><?php echo e(session()->get('locale')); ?><?php else: ?><?php echo e($configData['defaultLanguage']); ?><?php endif; ?>"
 data-textdirection="<?php echo e($configData['direction'] == 'rtl' ? 'rtl' : 'ltr'); ?>" data-asset-path="<?php echo e(asset('/')); ?>">
  <!-- BEGIN: Head-->
...
<?php /**PATH C:\xampp\htdocs\CLIFO-CRM-TEMPLATE-laravel\laravel-version\resources\views/layouts/contentLayoutMaster.blade.php ENDPATH**/ ?>