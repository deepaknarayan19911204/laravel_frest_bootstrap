...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <?php if($configData['theme'] === 'dark'): ?><?php echo e('dark-layout'); ?> <?php elseif($configData['theme'] === 'semi-dark'): ?><?php echo e('semi-dark-layout'); ?> <?php else: ?> <?php echo e('light-layout'); ?> <?php endif; ?>" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" data-framework="laravel">
    <!-- BEGIN: Content-->
...
<?php /**PATH C:\xampp\htdocs\CLIFO-CRM-TEMPLATE-laravel\laravel-version\resources\views/layouts/fullLayoutMaster.blade.php ENDPATH**/ ?>