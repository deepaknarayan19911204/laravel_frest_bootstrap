<nav class="header-navbar navbar-expand-lg navbar navbar-with-menu navbar-brand-center <?php if($configData['navbarBgColor'] !== 'bg-white' ): ?>) <?php echo e($configData['navbarBgColor']); ?> <?php else: ?> <?php echo e('bg-primary'); ?> <?php endif; ?>
<?php if($configData['navbarType'] === 'navbar-static'): ?> <?php echo e('navbar-static-top'); ?> <?php else: ?> <?php echo e('fixed-top'); ?> <?php endif; ?>
<?php if($configData['theme'] === 'light'): ?> <?php echo e("menu-light"); ?> <?php else: ?> <?php echo e('menu-dark'); ?> <?php endif; ?>">
  <div class="navbar-header d-xl-block d-none">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item">
      <a class="navbar-brand" href="<?php echo e(asset('/')); ?>">
          <div class="brand-logo">
          <img src="<?php echo e(asset('images/logo/logo-light.png')); ?>" class="logo" alt="">
          </div>
      ...
      <div class="navbar-collapse" id="navbar-mobile">
        <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
          ...
          <!--<ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(asset('app/email/test')); ?>" data-toggle="tooltip" data-placement="top" title="Email"><i class="ficon bx bx-envelope"></i></a></li>
        ...
        <!--<ul class="nav navbar-nav float-right d-flex align-items-center">
              ...
              <li class="scrollable-container media-list">
                <a class="d-flex justify-content-between" href="javascript:void(0)">
                  <div class="media d-flex align-items-center">
                    <div class="media-left pr-0">
                      <div class="avatar mr-1 m-0"><img src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar" height="39" width="39"></div>
                    </div>
                    ...
                    <div class="media d-flex align-items-center">
                      <div class="media-left pr-0">
                        <div class="avatar mr-1 m-0">
                          <img src="<?php echo e(asset('images/portrait/small/avatar-s-16.jpg')); ?>" alt="avatar" height="39" width="39">
                        </div>
                      </div>
                      <div class="media-body">
                ...
                <div class="d-flex justify-content-between cursor-pointer">
                  <div class="media d-flex align-items-center py-0">
                    <div class="media-left pr-0">
                      <img class="mr-1" src="<?php echo e(asset('images/icon/sketch-mac-icon.png')); ?>" alt="avatar" height="39" width="39">
                    </div>
                    <div class="media-body">
                ...
                <div class="d-flex justify-content-between read-notification cursor-pointer">
                  <div class="media d-flex align-items-center">
                    <div class="media-left pr-0">
                      <div class="avatar mr-1 m-0"><img src="<?php echo e(asset('images/portrait/small/avatar-s-4.jpg')); ?>" alt="avatar" height="39" width="39"></div>
                    </div>
                    <div class="media-body">
                ...
                <div class="d-flex justify-content-between cursor-pointer">
                  <div class="media d-flex align-items-center border-0">
                    <div class="media-left pr-0">
                      <div class="avatar mr-1 m-0"><img src="<?php echo e(asset('images/portrait/small/avatar-s-16.jpg')); ?>" alt="avatar" height="39" width="39"></div>
                    </div>
                    <div class="media-body">
          ...
          <li class="dropdown dropdown-user nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right pb-0">
              <a class="dropdown-item" href="<?php echo e(asset('page/user/profile')); ?>"><i class="bx bx-user mr-50"></i> Edit Profile</a>
              <a class="dropdown-item" href="<?php echo e(asset('app/email/test')); ?>"><i class="bx bx-envelope mr-50"></i> My Inbox</a>
              <a class="dropdown-item" href="<?php echo e(asset('app/todo')); ?>"><i class="bx bx-check-square mr-50"></i> Task</a>
              <a class="dropdown-item" href="<?php echo e(asset('app/chat')); ?>"><i class="bx bx-message mr-50"></i> Chats</a>
              <div class="dropdown-divider mb-0"></div>
              <a class="dropdown-item" href="<?php echo e(asset('auth/login')); ?>"><i class="bx bx-power-off mr-50"></i> Logout</a>
            </div>
          </li>
        </ul>-->
      </div>
...
<?php /**PATH C:\xampp\htdocs\CLIFO-CRM-TEMPLATE-laravel\laravel-version\resources\views/panels/horizontal-navbar.blade.php ENDPATH**/ ?>